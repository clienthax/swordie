...
public class ItemConstants {
    ...
    public static int getBodyPartFromItem(int nItemID, int gender) {
        ...
        int result = !arr.isEmpty() ? arr.get(0) : 0;
        return result;
    }
    ...
    public static boolean nebuliteFitsEquip(Equip equip, Item nebulite) {
        ...
        return switch (type) {
            ...
            case Weapon -> // no emblems for nebs here
                    isWeapon(equipId) || isShield(equipId);
    ...
    public static int getDamageSkinIDByItemID(int itemID) {
        return switch (itemID) {
            case 2431965 -> // Basic Damage Skin:
                    0; // Digitalized Damage Skin:
            case 2431966, 2432084 -> // Digitalized Damage Skin
                    1;
            case 2431967 -> // Kritias Damage Skin:
                    2;
            case 2432131 -> // Party Quest Damage Skin:
                    3; // Hard-Hitting Damage Skin:
            // Hard-Hitting Damage Skin
            case 2432153, 2432638, 2432659 -> // Hard-Hitting Damage Skin
                    4; // Sweet Tea Cake Damage Skin:
            // Sweet Tea Cake Damage Skin
            case 2432154, 2432637, 2432658 -> // Sweet Tea Cake Damage Skin
                    5;
            case 2432207 -> // Club Henesys Damage Skin:
                    6;
            case 2432354 -> // Merry Christmas Damage Skin:
                    7; // Snowflake Damage Skin:
            case 2432355, 2432972 -> // Snowflake Damage Skin
                    8;
            case 2432465 -> // Alicia's Damage Skin:
                    9;
            case 2432479 -> // Dorothy Damage Skin:
                    10; // Keyboard Warrior Damage Skin:
            // Keyboard Warrior Damage Skin
            case 2432526, 2432639, 2432660 -> // Keyboard Warrior Damage Skin
                    11;
            case 2432532 -> // Gentle Springtime Breeze Damage Skin:
                    12;
            case 2432592 -> // Singles Army Damage Skin:
                    13; // Reminiscence Damage Skin:
            case 2432640, 2432661 -> // Reminiscence Damage Skin
                    14;
            ...
            case 2434248 -> // Rainbow Boom Damage Skin:
                    34; // Night Sky Damage Skin:
            case 2433362, 2433900 -> // Night Sky Damage Skin
                    35;
            ...
            case 2433571 -> // Scribble Crush Damage Skin:
                    44; // Autumn Festival Full Moon Damage Skin:
            case 2434374, 2434574 -> // Full Moon Damage Skin
                    45; // White Heaven Sun Damage Skin:
            // Sunny Damage Skin
            case 2433828, 2434575, 2435171 -> // Sunny Damage Skin
                    46;
            ...
            case 2434868 -> // Christmas Lights Damage skin:
                    76; // Heroes Phantom Damage Skin:
            // Heroes Phantom Damage Skin
            case 2435043, 2435665, 2436041 -> // Heroes Phantom Damage Skin
                    77; // Heroes Mercedes Damage Skin:
            // Heroes Mercedes Damage Skin
            case 2435044, 2435666, 2436042 -> // Heroes Mercedes Damage Skin
                    78;
            case 2435046 -> // Fireworks Damage Skin:
                    79;
            case 2435047 -> // Heart Balloon Damage Skin:
                    80; // Neon Sign Damage Skin:
            case 2435140, 2435836 -> // Neon Sign Damage Skin
                    81;
            ...
            case 2435157 -> // Calligraphy Damage Skin:
                    85; // Explosion Damage Skin:
            case 2435158, 2435835 -> // Explosion Damage Skin
                    86;
            case 2435159 -> // Snow-wing Damage Skin:
                    87; // Miho Damage Skin:
            case 2435160, 2436044 -> // Miho Damage Skin
                    88;
            ...
            case 2433113 -> // Chinese Marshmallow Damage Skin:
                    1008; // Chalk Damage Skin:
            case 2433236, 2433899 -> // Chalk Damage Skin
                    1010;
            ...
            case 2435380 -> // Math Symbol Damage Skin:
                    1065; // Secret Sign Damage Skin:
            // Secret Sign Damage Skin
            case 2435381, 2435638, 2435918 -> // Secret Damage Skin(Special character)
                    1066;
    ...
    public static boolean isCollisionLootItem(int itemID) {
        return switch (itemID) { // Blue
            // Purple
            // Red
            case 2023484, 2023494, 2023495, 2023669 -> // Gold
                    true;
            default -> false;
        };
    }
    ...
    public static boolean isUpgradable(int itemID) {
        ...
        return switch (bodyPart) {
            case Ring1, Ring2, Ring3, Ring4, Pendant, ExtendedPendant, Weapon, Belt, Hat, FaceAccessory, EyeAccessory,
                 Top, Bottom, Shoes, Earrings, Shoulder, Gloves, Badge, Shield, Cape, MechanicalHeart -> true;
            default -> false;
        };
    }
    ...
    public static int getEquippedSummonSkillItem(int itemID, short job) {
        return switch (itemID) {
            case 1112585 ->// Angelic Blessing
                    (SkillConstants.getNoviceSkillRoot(job) * 10000) + 1085;
            case 1112586 ->// Dark Angelic Blessing
                    (SkillConstants.getNoviceSkillRoot(job) * 10000) + 1087;
            case 1112594 ->// Snowdrop Angelic Blessing
                    (SkillConstants.getNoviceSkillRoot(job) * 10000) + 1090;
            case 1112663 ->// White Angelic Blessing
                    (SkillConstants.getNoviceSkillRoot(job) * 10000) + 1179;
