...
public class Demian {
    ...
    public static ScheduledFuture<?> stigmaIncinerateObjectTimer(Field field) {
        ...
        return EventManager.addFixedRateEvent(() -> field.spawnLifeForTime(o, BossConstants.DEMIAN_STIGMA_INCINERATE_OBJECT_DURATION_TIME), 5000, BossConstants.DEMIAN_STIGMA_INCINERATE_OBJECT_RESPAWN_TIME, TimeUnit.MILLISECONDS);
    }
